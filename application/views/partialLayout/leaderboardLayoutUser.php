    ...
    <div class="">
        ...
        <div class="container-fluid">
            ...
            if(isset($scenesList) && count($scenesList)>0){
                ?>
                <div class="challengeDiv" style="padding: 10px">
                    <div class="form-horizontal col-lg-6 col-md-7">
                        <div class="form-group">
                            <label for="challengeSelect" class="control-label col-lg-2 col-md-3">Challenge</label>
                            <div class="col-lg-10 col-md-9">
                                <select id="challengeSelect" class="form-control">
                                    <option value="0">select challenge</option>
                                    <?php
                                    foreach ($scenesList as $scenes){
                                        $scenes=new Scenes($scenes);
                                        ?>
                                        <option value="<?=$scenes->getScenesId()?>"><?=$scenes->getScenesName()?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
